...
<div class="div_head">
            <span>
                <span style="float: left;">当前位置是：预约管理-》添加预约-》选择用户</span>
                <span style="float: right; margin-right: 8px; font-weight: bold;">
                    <a style="text-decoration: none" href="./index.php?r=aptm/add&ord_itm_id=0">【返回】</a>
                </span>
            </span>
</div>
<div></div>
<div style="font-size: 13px; margin: 10px 5px;">
    <table class="table_a" border="1" width="100%">
        ...
        foreach ($cust_info as $_v) {
            ...
            //第一列（超链接选择）
            echo '<td><a href="./index.php?r=aptm/selectOrderItem&usr_id=';
            echo $_v->pk_cust_id;
            echo '">选择该用户订单</a></td>';
