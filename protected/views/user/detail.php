...
<div class="div_head">
            <span>
	            ...
	            <span style="float:right;margin-right: 8px;font-weight: bold">
                    <a style="text-decoration: none" href="./index.php?r=user/update&id=<?php echo $user_info->pk_usr_id; ?>">【修改用户信息】</a>
                </span>
            </span>
</div>
<div></div>
	...
	<table border="1" width="100%" class="table_a">
		...
		<tr>
			...
			<td>
				<span style="float:left;margin-left: 8px;font-weight: bold">
                    <a style="text-decoration: none" href="./index.php?r=user/initPassword&id=<?php echo $user_info->pk_usr_id ?>&page=1">初始化用户密码</a>
                </span>
			</td>
		</tr>
		<tr>
		...
		<?php if($user_info->usr_kind === "0") { ?>
			...
			<tr>
				...
				<td>
					<?php
					if($admin_info->adm_level == 0)
						echo $form->label($admin_info,'普通管理员');
					else
						echo $form->label($admin_info,'超级管理员');
					?>
				</td>
			</tr>
		<?php
		...
		elseif($user_info->usr_kind === "1") {?>
			...
			<tr>
				<td>
					<?php echo $form->label($beautician_info, 'beau_valid'); ?>
				</td>
				<td>
					<?php echo $form->label($beautician_info,$beautician_info->beau_valid); ?>
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					...
					<?php //echo $beautician_info->beau_email; ?>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					...
					<?php echo $beautician_info->beau_intro; ?>
				</td>
			</tr>
		<?php
		}
		elseif($user_info->usr_kind === "2") { ?>
			...
			<tr>
				...
				<td>
					<?php echo $customer_info->cust_balance; ?>
			...
			<tr>
				...
				<td>
					<?php echo $customer_info->cust_email1; ?>
			...
			<tr>
				...
				<td>
					<?php echo $customer_info->cust_email2; ?>
