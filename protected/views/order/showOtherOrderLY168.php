...
<div class="div_head">
            <span>
                <span style="float: left;">当前位置是：订单管理-》订单一览（联洋168元）</span>
                <span style="float: right; margin-right: 8px; font-weight: bold;">
                    <a style="text-decoration: none;" href="./index.php?r=order/addOther&kind=<?php echo OTHER_KIND_LY168YUAN ?>">【添加联洋168元订单】</a>
                </span>
            </span>
</div>
<div></div>
