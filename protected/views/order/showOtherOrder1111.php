...
<div class="div_head">
            <span>
                <span style="float: left;">当前位置是：订单管理-》订单一览（双11）</span>
                <span style="float: right; margin-right: 8px; font-weight: bold;">
                    <a style="text-decoration: none;" href="./index.php?r=order/addOther&kind=<?php echo OTHER_KIND_1111 ?>">【添加双11订单】</a>
                </span>
            </span>
</div>
<div></div>
